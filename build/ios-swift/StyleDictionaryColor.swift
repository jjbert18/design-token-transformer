...
// Generated on Mon, 13 Dec 2021 15:57:28 GMT
...
public enum StyleDictionaryColor {
    ...
    public static let depth = #16171829
    public static let focus = #008cff80
    public static let glyph = #f99222
    ...
    public static let lightPrimary = #ffffff
    public static let lightSecondary = #f9f9f9
    public static let lightTertiary = #f2f2f2
    public static let link = #0050a9
    public static let linkDisabled = #7f878a
    public static let linkDisabledSubtle = #dde0e2
